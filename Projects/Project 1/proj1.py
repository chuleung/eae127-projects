...
x = np.genfromtxt('naca0012_a8_x.dat', delimiter=',')
z = np.genfromtxt('naca0012_a8_z.dat', delimiter=',')
Cp = np.genfromtxt('naca0012_a8_Cp.dat', delimiter=',')
...
x1, SCp1_0 = np.genfromtxt('naca0012_surfCP_a0.dat',skip_header=1,unpack=True)
...
x1, SCp1_8 = np.genfromtxt('naca0012_surfCP_a8.dat',skip_header=1,unpack=True)
...
#Same process as above
x2, SCp2_0 = np.genfromtxt('naca2412_surfCP_a0.dat',skip_header=1,unpack=True)
...
#Same process as above
x2, SCp2_8 = np.genfromtxt('naca2412_surfCP_a8.dat',skip_header=1,unpack=True)
